                      ...
                      <form action="" id="form-submit-contact">
                          ...
                          <div class="flex flex-wrap justify-between -mx-3">
                              <div class="w-full md:w-1/2 px-3">
                                  <label class="inline-block w-full text-gray-500">{{$fcSystem['title_8']}} *</label>
                      ...
                      <div class="bg-gray-100 border border-gray-200 p-[10px] md:p-[25px]">
                          ...
                          <div class="border-t border-gray-200 pt-5 mt-5">
                              <ul class="flex flex-wrap justify-center">
                                  <li>
                                      <a href="{{$fcSystem['social_facebook']}}" target="_blank" class="w-[35px] h-[35px] leading-[35px] text-center bg-gray-700 text-white inline-block rounded-full mx-[2px] hover:bg-Orangefc5 transition-all relative">
                                  ...
                                  <li>
                                      <a href="{{$fcSystem['social_twitter']}}" target="_blank" class="w-[35px] h-[35px] leading-[35px] text-center bg-gray-700 text-white inline-block rounded-full mx-[2px] hover:bg-Orangefc5 transition-all relative">
                                  ...
                                  <li>
                                      <a href="{{$fcSystem['social_instagram']}}" target="_blank" class="w-[35px] h-[35px] leading-[35px] text-center bg-gray-700 text-white inline-block rounded-full mx-[2px] hover:bg-Orangefc5 transition-all relative">
                                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30" class="w-5 h-5 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 " style=" fill:#fff;">
                                  ...
                                  <li>
                                      <a href="{{$fcSystem['social_youtube']}}" target="_blank" class="w-[35px] h-[35px] leading-[35px] text-center bg-gray-700 text-white inline-block rounded-full mx-[2px] hover:bg-Orangefc5 transition-all relative">
                                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30" class="w-5 h-5 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 " style=" fill:#fff;">
