        ...
        <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            ...
            <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                <form action="{{route('customer.login-store')}}" method="POST" id="form-auth">
                    ...
                    <!-- Password input -->
                    <div class="mb-3">
                        <input type="password" name="password" class="form-control block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" value="{{old('password')}}" placeholder="Mật khẩu" />
                    </div>
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <a href="{{route('customer.reset-password')}}" class="text-gray-800">Quên mật khẩu?</a>
                    </div>
