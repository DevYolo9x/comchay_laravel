                ...
                <div class="cursor-pointer relative flex ">
                    <div class="w-10 h-10 flex-none image-fit mr-1">
                        <img alt="Rocketman - HTML Admin Template" class="rounded-full"
                            src="{{asset('backend/images/profile-5.jpg')}}">
                        <div
    ...
    <div class=" mr-auto sm:mr-6">
        <div class="notification cursor-pointer">
            ...
            <div class="dropdown"> <button class="dropdown-toggle btn btn-primary" aria-expanded="false"
                    data-tw-toggle="dropdown">{{!empty(config('app.locale') == 'vi')?'Vietnamese':'English'}}</button>
                <div class="dropdown-menu w-40">
                    <ul class="dropdown-content">
                        <li><a class="dropdown-item" href="{{ route('components.language', ['vi']) }}">Vietnamese</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('components.language', ['en']) }}">English</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class=" dropdown text-slate-200 h-10">
        <div class="h-full dropdown-toggle flex items-center" role="button" aria-expanded="false"
            ...
            <div class="w-10 h-10 image-fit">
                <img alt="{{!empty(Auth::user())?Auth::user()->name:''}}"
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content">
                <li>
                    <a href="{{route('admin.profile')}}" class="dropdown-item"> <i data-lucide="user"
                            class="w-4 h-4 mr-2"></i> Hồ sơ cá nhân </a>
                </li>

                <li>
                    <a href="{{route('admin.profile-password')}}" class="dropdown-item"> <i data-lucide="lock"
                ...
                <li>
                    <a href="{{route('admin.logout')}}" class="dropdown-item"> <i data-lucide="toggle-right"
