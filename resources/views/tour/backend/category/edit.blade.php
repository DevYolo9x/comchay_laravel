...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form"
        action="{{route('tour_categories.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
        <div class=" col-span-12 lg:col-span-8">
            ...
            <div class=" box p-5">
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-2">
                        <?php echo Form::textarea('content', $detail->content, ['id' => 'ckContent', 'class' => 'ck-editor', 'style' => 'height:60px;font-size:14px;line-height:18px;border:1px solid #ddd;padding:10px']);?>
                    </div>
                </div>
                <div class="mt-3">
        ...
        <div class=" col-span-12 lg:col-span-4">
            <div class=" box p-5 pt-3">
                <div>
                    ...
                    <?php echo Form::select('parentid', $catalogue, $detail->parentid, ['class' => 'tom-select-custom tom-select w-full','data-placeholder'=>"Select your favorite actors"]); ?>
                </div>
            </div>
