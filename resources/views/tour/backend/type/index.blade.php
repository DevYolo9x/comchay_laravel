...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            @can('tours_create')
            <a href="{{route('tour_types.create')}}" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            @endcan
        </div>
        <!-- BEGIN: Data List -->
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                @can('tours_edit')
                                <a class="flex items-center mr-3" href="{{ route('tour_types.edit',['id'=>$v->id]) }}">
                                ...
                                <a class="flex items-center text-danger ajax-delete " href="javascript:void(0);"
                                    ...
                                    data-title="Lưu ý: Khi bạn thực hiện xóa, bài viết sẽ bị xóa vĩnh viễn. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!">
