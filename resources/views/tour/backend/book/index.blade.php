            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Tour</th>
                        <th class="whitespace-nowrap">Adult</th>
                        <th class="whitespace-nowrap">Children</th>
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td>
                            <p><b>CODE:</b> <a
                                    href="{{route('tour_books.edit',['id'=>$v->id])}}">#<?php echo $v->code; ?></a></p>
                        ...
                        <td>
                            <a class="text-primary" href="{{route('routerURL',['slug'=> $v->tour->slug])}}"
                                target="_blank">{{$v->tour->title}}</a>
                        </td>
                        <td>
                            {{$v->adult}}
                        </td>
                        ...
                        <td class="">
                            ...
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{ route('tour_books.edit',['id'=>$v->id]) }}">
