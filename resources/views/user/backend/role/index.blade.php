...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            @can('roles_create')
            <a href="{{route('roles.create')}}" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            @endcan
        </div>
        <!-- BEGIN: Data List -->
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                @can('roles_edit')
                                <a class="flex items-center mr-3" href="{{ route('roles.edit',['id'=>$v->id]) }}">
                                ...
                                <a class="flex items-center text-danger p-destroy" href="javascript:;"
                                    data-url="{{ route('roles.destroy',['id'=>$v->id]) }}" data-id="{{ $v->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
