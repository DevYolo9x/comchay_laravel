...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('tags.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class=" col-span-12 lg:col-span-4">
            ...
            <div class=" box p-5 mt-3">
                ...
                <div class="mt-2">
                    <?php echo Form::select('module', $moduleTag, $detail->module, ['class' => 'form-control w-full ']); ?>
                </div>
            </div>
        </div>
    </form>
