        ...
        <div class="flex flex-wrap justify-between text-center">
            <div class="w-full md:w-1/2">
                <a href="" class="logo-footer">
                    <img src="<?php echo e(asset('frontend/images/logo.png')); ?>" alt="" class="inline-block">
                </a>
            </div>
            <div class="w-full md:w-1/2">
                <a href="">
                    <img src="<?php echo e(asset('frontend/images/fanpage.jpg.webp')); ?>" alt="" class="inline-block">
                </a>
            </div>
        </div>
                ...
                <div class="item">
                    <div class="flex flex-wrap justify-between ">
                        <div class="w-full md:w-1/4">
                            <img src="<?php echo e(asset('frontend/images/bct.png')); ?>" alt="">
                        </div>
...
*/ ?><?php /**PATH D:\Xampp\htdocs\comchay.laravel\resources\views/homepage/common/footer.blade.php ENDPATH**/ ?>