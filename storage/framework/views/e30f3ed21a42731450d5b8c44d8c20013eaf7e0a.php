...
$(document).on('click', '.add-slide', function() {
    ...
    if (catalogueid == 0) {
        ...
        let formURL = "<?php echo e(route('slides.store')); ?>";
        $.ajax({
            headers: {
...
$(document).ready(function() {
    ...
    $(document).on('click', '.add-group', function() {
        ...
        let formURL = "<?php echo e(route('slides.category_store')); ?>";
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-group', function() {
        ...
        let formURL = "<?php echo e(route('slides.category_update')); ?>";
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
...
$(document).on('click', '.update-slide', function() {
    ...
    let formURL = "<?php echo e(route('slides.update')); ?>";
    swal({
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Xampp\htdocs\comchay.laravel\resources\views/slide/backend/script.blade.php ENDPATH**/ ?>