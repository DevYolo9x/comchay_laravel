...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('briefings_create')): ?>
            <a href="<?php echo e(route('briefings.create')); ?>" class="btn btn-primary shadow-md mr-2 hidden">Thêm mới</a>
            <?php endif; ?>
        </div>
        <!-- BEGIN: Data List -->
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td>
                            ...
                            <a class="text-danger" href="<?php echo e(route('briefings.index',['catalogueid' => $c->id])); ?>"><?php echo !empty($kc == 0) ? '' : ',' ?><?php echo e($c->title); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </td>
                        <td>
                            <?php if($v->type == 'admin'): ?>
                            <?php echo e($v->user->name); ?>(Quản trị viên)
                            <?php else: ?>
                            <?php echo e($v->customer->name); ?>
                        ...
                        <td class="table-report__action w-56 ">
                            <div class="flex justify-center items-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('briefings_edit')): ?>
                                <a class="flex items-center mr-3" href="<?php echo e(route('briefings.edit',['id'=>$v->id])); ?>">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                    Edit
                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('briefings_destroy')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel.local\resources\views/briefing/backend/briefing/index.blade.php ENDPATH**/ ?>