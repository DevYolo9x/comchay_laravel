            ...
            <div class="grid">
                <div class="navbar-collapse collapse grow items-center">
                    <ul class="navbar-nav mr-auto flex space-x-5 justify-end">
                        ...
                        <li class="nav-item">
                            <a href="tel:<?php echo e($fcSystem['contact_hotline']); ?>" class="inline-block text-f20 font-bold mt-[8px] text-brown">
                                <span class="inline-block mr-2"><i class="fa-solid fa-phone-volume"></i></span>
                                Hotline: <?php echo e($fcSystem['contact_hotline']); ?>

                            </a>
                        </li>
                        <li class="cart mt-[7px]">
                            <a class="cursor-pointer relative">
                                <img src="<?php echo e(asset('frontend/images/cart.webp')); ?>" alt="" class="w-[25px]">
        ...
        <div class="container py-[14px] mx-auto px-3 relative">
            <div class="inline-block w-full">
                <div class="main-logo absolute z-10 top-0">
                    <a href="<?php echo e(url('')); ?>"><img src="<?php echo e(asset($fcSystem['homepage_logo'])); ?>" alt="<?php echo e($fcSystem['homepage_company']); ?>" style="width: 138px;" /></a>
                </div>
                <div class="main-menu pl-5 float-right">
                    <ul class="flex lg:flex-grow md:space-x-0 lg:space-x-4 mt-0 lg:mt-[8px] justify-end">
                        ...
                        <?php $__currentLoopData = $menu_header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="group relative">
                            <a href="<?php echo e(url($child->slug)); ?>" class="text-white inline-block px-[5px] lg:px-[8px] py-[10px] font-bold text-f14 lg:text-f16  transition-all">
                            ...
                            <ul class="group-hover:block hidden absolute dropdown left-0 top-full z-30 bg-white p-[10px] submenu">
                                <?php $__currentLoopData = $child->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyC => $childC): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(url($childC->slug)); ?>" class="hover:text-blue003 text-f15 inline-block mb-2 hover:text-Orangefc5"><?php echo e($childC->title); ?></a>
                                </li>
...
<header class="block md:hidden header-mobile">
    ...
    <div class="relative flex justify-center px-2 py-[10px] header-22">
        ...
        <div class="w-full text-center">
            ...
            <a href="" class="logo"><img src="<?php echo e(asset('frontend/images/logo.png')); ?>" alt="" class="inline-block" /></a>
        </div>
                ...
                <ul class="flex lg:flex-grow space-x-4 float-right">
                    <li class="relative">
                        <a class="cursor-pointer click-search">
                            <img src="<?php echo e(asset('frontend/images/search.webp')); ?>" alt="" class="w-[25px]">
                        </a>
...
*/ ?><?php /**PATH D:\Xampp\htdocs\comchay.laravel\resources\views/homepage/common/header.blade.php ENDPATH**/ ?>