    ...
    $("#myDropzone").dropzone({
        ...
        removedfile: function(file) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo e(route("dropzone_delete")); ?>',
                data: {
                    filename: name
                },
                success: function(data) {
                    console.log("Delete image successfully uploaded");
                },
                error: function(e) {
                    console.log(e);
                }
...
<!-- end: dropzone upload image --><?php /**PATH D:\xampp\htdocs\laravel.local\resources\views/components/dropzone.blade.php ENDPATH**/ ?>