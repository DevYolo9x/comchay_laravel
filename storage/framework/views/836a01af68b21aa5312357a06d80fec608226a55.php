            ...
            <table class="table table-report -mt-2">
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td>
                            <a href="<?php echo e(route('routerURL',['slug'=>$v->slug])); ?>" class="text-primary font-bold" target="_blank"><?php echo $v->title; ?></a>
                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel.local\resources\views/article/backend/article/index.blade.php ENDPATH**/ ?>