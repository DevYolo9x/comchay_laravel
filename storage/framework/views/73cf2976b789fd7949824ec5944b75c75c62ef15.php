            ...
            <div class="col-span-12 lg:col-span-9 space-y-6 mt-5 md:mt-0 order-0 lg:order-1">
                <div>
                    <div class="flex justify-between items-center border-b border-global">
                        <h2 class="h2-category h2-main text-global font-bold text-lg  tracking-tighter relative pb-1"><span class="uppercase"> GỬI TRÍCH DẪN MỚI</span></h2>
                    </div>
...
<script type="text/javascript">
    $('#form-comment-submit').click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo route('chude.storeComment') ?>",
            headers: {
            ...
            success: function(responsive) {
                if (responsive == 200) {
                    ...
                    $('.error_comment .js_text_success').html("Gửi trích dẫn thành công");
                    $('html, body').animate({
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel.local\resources\views/briefing/frontend/briefing/trichdan.blade.php ENDPATH**/ ?>