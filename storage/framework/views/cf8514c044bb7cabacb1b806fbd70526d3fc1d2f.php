...
<script>
    ...
    function openKCFinderSystem(field, $type = '') {
        CKFinder.modal({
            chooseFiles: true,
            width: 1000,
            height: 700,
    ...
    function openKCFinderAddItem(field, $type = '') {
        CKFinder.modal({
            chooseFiles: true,
            width: 1000,
            height: 700,
...
</script><?php /**PATH D:\Xampp\htdocs\comchay.laravel\resources\views/dashboard/common/footer.blade.php ENDPATH**/ ?>