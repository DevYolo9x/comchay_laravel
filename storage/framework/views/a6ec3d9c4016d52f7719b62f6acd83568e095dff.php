                            ...
                            <?php if ($item == 'image') { ?>
                                <div class="mt-3">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <input type="text" name="config_colums_json_<?php echo $keyword_convert ?>[<?php echo $listType['keyword'][$key] ?>][]" value="<?php echo $content[$listType['keyword'][$key]][$k] ?>" class="form-control " placeholder="Đường dẫn của <?php echo $listType['title'][$key] ?>" onclick="openKCFinderAddItem($(this))" autocomplete="off">
                                    </div>
                                </div>
                            <?php } else if ($item == 'input') { ?>
                                <input type="text" name="config_colums_json_<?php echo $keyword_convert ?>[<?php echo $listType['keyword'][$key] ?>][]" value="<?php echo $val ?>" class="form-control mt-3" placeholder="<?php echo $listType['keyword'][$key] ?>">
                            <?php } else if ($item == 'textarea') { ?>
                                <textarea type="text" name="config_colums_json_<?php echo $keyword_convert ?>[<?php echo $listType['keyword'][$key] ?>][]" class="form-control mt-3" placeholder="<?php echo $listType['keyword'][$key] ?>"><?php echo $content[$listType['keyword'][$key]][$k] ?></textarea>
                            <?php } else if ($item == 'editor') { ?>
                                <div class="mt-3">
                                    <textarea type="text" name="config_colums_json_<?php echo $keyword_convert ?>[<?php echo $listType['keyword'][$key] ?>][]" id="editorId<?php echo $k ?>" class="ck-editor form-control mt-3"><?php echo $content[$listType['keyword'][$key]][$k] ?></textarea>
                                </div>
                            <?php } ?>
                        <?php } ?>
                    <?php } ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\laravel.local\resources\views/components/field/json.blade.php ENDPATH**/ ?>